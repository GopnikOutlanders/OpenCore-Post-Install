...
* [Set `acpi-wake-type` to the USB Controller(Recommended)](keyboard.md/#method-1-add-wake-type-property-recommended)
* [Create a fake ACPI Device](keyboard.md/#method-2-create-a-fake-acpi-device)
* [Disable darkwake(not ideal, as background tasks will also turn on the display)](keyboard.md/#method-3-configuring-darkwake)
